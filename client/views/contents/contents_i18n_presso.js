...
App.component('i18n.translations.en.contents.presso').expose({
	title: 'Presso',
	description: 'After almost half a year of construction and refurbishing on the 23rd of April the PRESSO coffeehouse is finally opened for the public. Apple and soft cheese pie, chocolate muffin, ham and vegetable rolls - all that you can have as a side dish to a good coffee. '
});
