...
App.component('i18n.translations.en.rooms').expose({
...
App.component('i18n.translations.hu.rooms').expose({
	'description': '2007-ben, a Ferdinánd panzió megnyitásakor, a ' +
	'szálláshely csupán 5 szobával bírt. 2012-re sikerült a szobák' +
...
App.component('i18n.translations.ro.rooms').expose({
	...
	'avea numai cinci camere. În 2012 am reușit să dublăm capacitatea ' +
